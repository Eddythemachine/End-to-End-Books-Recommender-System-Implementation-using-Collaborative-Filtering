    ...
    def download_data(self):
        try:
            ...
            if os.path.exists(zip_file_path):
                logging.info(f"Dataset already exists at {zip_file_path}. Skipping download.")
                return zip_file_path

            raise Exception(
                f"Dataset not found at {zip_file_path}. "
                f"Please download it manually and place it there."
            )
    ...
    def initiate_data_ingestion(self):
        try:
            ...
            if file_path.endswith(".zip"):
                ...
                logging.info("GZ file detected. Extraction not implemented yet.")

            elif file_path.endswith(".csv"):
                logging.info("CSV file detected. No extraction required.")

            else:
                logging.warning("Unknown file type. Skipping extraction.")
